  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl '>
     ...
     {currState === "Signup" && !isDataSubmitted && (
      ...
      {
        currState === "Signup" && isDataSubmitted && (
          <textarea onChange={(e)=>setBio(e.target.value)} value={bio} rows={4} name="" id="" className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-indigo-500' placeholder='Provide a short bio...' required></textarea>
        )
      }
      ...
      <div>
        <input type="checkbox" />
        <p>Agree to the terms of us & privacy policy</p>
      </div>
